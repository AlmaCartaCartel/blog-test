                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            $categories,
                            $post -> category === null ? null : $post -> category_id,
...
{{--                                <input type="checkbox" name="is_featured" class="minimal" {{ $post -> is_featured === 1 ? 'checked': '' }}>--}}
                            </label>
                            <label>
                                Рекомендовать
                            </label>
...
{{--                                <input type="checkbox" name="status" class="minimal" {{ $post -> status === 1 ? 'checked': '' }}>--}}
                            </label>
                            <label>
                                Черновик
                            </label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="30" rows="10" class="form-control">{{ $post -> description }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
