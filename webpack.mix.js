...
mix.styles([
    ...
    'resources/admin/datepicker/datepicker3.css',
    'resources/admin/select2/select2.min.css',
    'resources/admin/datatables/dataTables.bootstrap.css',
